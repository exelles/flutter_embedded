...
dev_list="bison cdbs curl dpkg-dev elfutils devscripts fakeroot
          flex g++ git git-svn gperf
          libasound2-dev libbrlapi-dev ffmpeg
...
# libpixman-1-0-dbg libsqlite3-0-dbg libx11-6-dbg libxcb1-dbg libxcursor1-dbg libxdamage1-dbg libxfixes3-dbg libxi6-dbg libxrandr2-dbg libxrender1-dbg libxtst6-dbg libgtk2.0-0-dbg libpango1.0-0-dbg
dbg_list="libatk1.0-dev libc6-dbg libcairo2-dev libfontconfig1-dev
          libglib2.0-dev  libpcre3-dbg
          libxau6-dbg
          libxcomposite1-dbg
          libxdmcp6-dbg libxext6-dbg libxinerama1-dbg
          zlib1g-dbg"
